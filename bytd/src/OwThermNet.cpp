...
public:
    ...
    bool check()
    {
        ...
        case eOwWriteBitsFailure:
            if(len == sizeof(int32_t))
                return true;
            LogERR("pru msg unexpected size len:{} code:{}", len, i);
            break;
        case eOwPresenceOk:
        case eOwNoPresence:
    ...
    static std::string getCodeStr(ResponseCode code)
    {
        ...
        case eRspError:
            return "eRspError";
        case eOwPresenceOk:
            return "eOwPresenceOk";
        case eOwBusFailure0:
            return "eOwBusFailure0";
        case eOwBusFailure1:
            return "eOwBusFailure1";
        case eOwNoPresence:
            return "eOwNoPresence";
        case eOwBusFailureTimeout:
            return "eOwBusFailureTimeout";
        case eOwReadBitsOk:
            return "eOwReadBitsOk";
        case eOwReadBitsFailure:
            return "eOwReadBitsFailure";
        case eOwWriteBitsOk:
            return "eOwWriteBitsOk";
        case eOwWriteBitsFailure:
            return "eOwWriteBitsFailure";
        default:
            return "???";
        }
    }
...
bool OwThermNet::read_scratchpad(const RomCode& rc, ThermScratchpad& v)
{
    ...
    if((v.conf != 0x7F) || (v.reserved[0] != 0xFF) || (v.reserved[2] != 0x10)) {
